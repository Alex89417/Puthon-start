...
# print(quick_sort([4, 5, 9, 6, 3, 58, 7, 5, 2, 7]))
...
def nequick_sort(symbol, count):
 return symbol * count
 print(nequick_sort('!', 5)) # !!!!!
 print(nequick_sort('!')) # TypeError missing 1 required ...
...
def nequick_sort(symbol, count=3):
 return symbol * count
print(nequick_sort('!', 5)) # !!!!!
print(nequick_sort('!')) # !!!
print(nequick_sort(4)) # 12
...
def concatenatio(*params):
 ...
 res += item
 return res
print(concatenatio('a', 's', 'd', 'quick_sortdquick_sortconcatenatio('a', '1')) # a1
